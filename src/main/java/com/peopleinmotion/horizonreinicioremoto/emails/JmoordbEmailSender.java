 ...
 */
package com.peopleinmotion.horizonreinicioremoto.emails;
...
//    final String username = "horizonreinicioremoto@gmail.com";
//        final String password = "reinicio123";
        Boolean texthtml = false;
        if (typehtml.length != 0) {
            texthtml = typehtml[0];
...
//       public Boolean gmailToBCCCC(String to, String titulo, String mensaje,
//            String from, String password, Boolean... typehtml){
//                
      public Boolean gmailToBCCCC(String[] to, String[] cc, String[] bcc, String titulo, String mensaje,String from, String password, Boolean... typehtml)  {
//   final String username = "horizonreinicioremoto@gmail.com";
//        final String password = "reinicio123";
        Boolean texthtml = false;
        if (typehtml.length != 0) {
